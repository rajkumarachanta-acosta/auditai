    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .toolkit-link{color:#8b949e;font-size:12px;font-weight:600;text-decoration:none;transition:color .15s}
        .toolkit-link:hover{color:#fff}
        .nav-sep{width:1px;height:18px;background:rgba(255,255,255,.15)}
      ...
      <div className="app">
        ...
        <div className="topnav">
          <div className="nav-left">
            <Link className="toolkit-link" href="/">← Retail Media Toolkit</Link>
